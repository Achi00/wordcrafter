        ...
        <div className="flex flex-col gap-10">
          ...
          {contentSummarize ? (
            ...
            <div className="space-y-3 bg-white p-4 rounded-md border">
              <h4 className="text-lg font-semibold">Content Summary with AI</h4>
              <p className="text-sm text-gray-600">
                <Alert variant="destructive">
                  ...
                  <AlertDescription className="mt-2">
                    ...
                    summarize in the editor. This will enable the AI to process
                    your content and provide a concise summary.
                    <br />{" "}
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-medium">Input</span> your text into the
